...
- Week B accessory (all phases): Single-Leg Squat to Bench 3×6/6 (surgery side first, BW → DB). Addresses L/R imbalance — weak knee-surgery side causes the other leg's calf to overload.
