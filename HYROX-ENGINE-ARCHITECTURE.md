...
The HYROX ENGINE is a single-file web app (index.html) for HYROX race training, built for Scott (Lad) Bain, a PE teacher and competitive HYROX athlete targeting a December 2026 race in Malaga. The app is hosted at `scottbain-dot.github.io/TRAIN/`.
...
### Threshold Progression Targets (path to 4:00/km)
...
- `z2Efficiency(workouts)` — Cardiac efficiency trending (avg HR in Z2 over time)
- `sessionTargets(sessionType)` — Returns HR targets for a session type

**Readiness Score (0-100):**
- RHR component: 7-day avg vs 60-day baseline (lower = better)
- HRV component: 7-day avg vs 60-day baseline (higher = better)  
- Sleep component: duration + deep + REM quality
- Training load component: yesterday's TRIMP vs 7-day average
- Weighted combination with labels: peak (85+), good (70-84), moderate (55-69), low (<55)
...
- Target race: Malaga, December 2026
